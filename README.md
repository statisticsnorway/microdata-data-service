...
````
docker run --publish 8000:8000 --env CONFIG_PROFILE=LOCAL --env DATASTORE_DIR=/datastore_path --env RESULTSET_DIR=/resultset_path -v /path/datastore:/datastore_path /path/resultset:/resultset_path data-service
````
